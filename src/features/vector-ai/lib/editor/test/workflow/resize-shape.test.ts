    ...
    const result = runGesture(initial, [
      {
        ...
        shapeId: "rect-1",
        handle: "se",
        world: { x: rect.transform.x + rect.w, y: rect.transform.y + rect.h },
      },
    ...
    const result = runGesture(initial, [
      {
        ...
        shapeId: "rect-1",
        handle: "nw",
        world: { x: rect.transform.x, y: rect.transform.y },
      },
    ...
    const result = runGesture(initial, [
      {
        ...
        shapeId: "circle-1",
        handle: "e",
        world: { x: circle.transform.x + circle.r, y: circle.transform.y },
      },
    ...
    const result = runGesture(initial, [
      {
        ...
        shapeId: "circle-1",
        handle: "n",
        world: { x: circle.transform.x, y: circle.transform.y - circle.r },
      },
